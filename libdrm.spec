...
Conflicts: xorg-x11-drv-nouveau = 1:0.0.15
...
Patch1: libdrm-fix-intel-memory-corruption.patch
...
%changelog
* Mon Apr 19 2010 Dave Airlie <airlied@redhat.com> 2.4.20-2
- fix intel incorrect memory allocation problem.

* Thu Apr 08 2010 Dave Airlie <airlied@redhat.com> 2.4.20-1
- pull in upstream .20 release - contains pretty much same patches
- fix includes harder to make mesa build

* Wed Mar 31 2010 Ben Skeggs <bskeggs@redhat.com> 2.4.19-6
- fix xorg-x11-drv-nouveau "Conflicts" to actually work

* Fri Mar 26 2010 Dave Airlie <airlied@redhat.com> 2.4.19-5
- fix up include files now they don't conflict with kernel.

* Thu Mar 25 2010 Ben Skeggs <bskeggs@redhat.com> 2.4.19-4
- fix libdrm.pc to include /usr/include/drm

* Thu Mar 25 2010 Ben Skeggs <bskeggs@redhat.com> 2.4.19-3
- conflict with older, incompatible, nouveau ddx

* Thu Mar 25 2010 Ben Skeggs <bskeggs@redhat.com> 2.4.19-2
- fixed angry libtool

* Tue Mar 23 2010 Ben Skeggs <bskeggs@redhat.com> 2.4.19-1
- upstream release 2.4.19 + git fixes up until today

* Mon Dec 21 2009 Dave Airlie <airlied@redhat.com> 2.4.17-1
- upstream release 2.4.17 - contains all the patches we rolled in

* Wed Dec 09 2009 Dave Airlie <airlied@redhat.com> 2.4.15-7
